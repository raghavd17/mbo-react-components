...
const Search = () => {
  return (
    <main className="p-4">
      ...
      <main className="search__bar">
        <section className="search__wrapper">
          <input
            className="search__input primary"
          ...
          <button
            className="btn link icon search__button"
            icon
          >
            <IconSearch />
          </button>
            ...
            <li className="menu__item" data-state="" tabIndex={1}>
              <div data-avatar="" className={`${style.avatar}`}>
                ...
                <div className={`${style.avatar__content}`}>
                  <div className={`${style.avatar__title}`}>
                    Camila Willians{" "}
                  </div>
                  <div className={`${style.avatar__desc} separated bullet`}>
                    <span>Category</span> <span>Content Writer</span>{" "}
                  </div>
                </div>
              </div>
            </li>
