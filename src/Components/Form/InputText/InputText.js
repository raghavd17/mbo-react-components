...
import styleLabel from "./../Label/_label.module.scss";
import styleLink from "./../../Link/_link.module.scss";
      ...
      <div className="grid grid-cols-2 grid-gap-sm">
        <sections className="grid">
          <div className={`${style.form_field}`}>
            ...
            <div className={`${style.form_field__info}`}>
              {/* {errorMessage && ( */}
              <label className={`${styleLabel.label}`}>Label Default</label>
              {/* {errorMessage} */}
              {/* )} */}
            </div>
          </div>
          {/* items */}
          <h2>Example with flag</h2>
          <div className={`${style.form_field}`}>
            <div className={`${style.form_field__control}`}>
              <div className={`${style.form_field__input_wrapper}`}>
                <span className={`${style.form_field__icon}`}>
                <a href="#" className={`${styleLink.link} ${styleLink.pill} ${styleLink.filter}`}>
          <svg
                    width="20"
                    height="16"
                    viewBox="0 0 22 16"
              ...
              <label
                htmlFor="inputField"
                className={`${style.form_field__label} ${style.has__filter}`}
              >
                Simple field
              </label>
            </div>
            <div className={`${style.form_field__info}`}>
              {/* {errorMessage && ( */}
              <label className={`${styleLabel.label}`}>Message Label</label>
              {/* {errorMessage} */}
              {/* )} */}
            </div>
          </div>
          {/* items */}
          <h2>Example with Regular Icon </h2>
          <div className={`${style.form_field}`}>
            <div className={`${style.form_field__control}`}>
              <div className={`${style.form_field__input_wrapper}`}>
                <span className={`${style.form_field__icon}`}>
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                      d="M4.29207 3L4.2728 3H4.2728C4.00922 2.99999 3.78184 2.99998 3.59456 3.01529C3.39688 3.03144 3.20028 3.06709 3.01109 3.16349C2.72884 3.3073 2.49937 3.53677 2.35556 3.81902C2.25916 4.0082 2.22351 4.20481 2.20736 4.40249C2.19205 4.58977 2.19206 4.81715 2.19207 5.08073V5.08073L2.19207 5.1V10.1489H1.69858C1.31277 10.1489 1 10.4617 1 10.8475C1 12.0011 1.93512 12.9362 3.08865 12.9362H13.0177C14.1713 12.9362 15.1064 12.0011 15.1064 10.8475C15.1064 10.4617 14.7936 10.1489 14.4078 10.1489H13.9155V5.1V5.08072C13.9155 4.81715 13.9155 4.58977 13.9002 4.40249C13.884 4.20481 13.8484 4.0082 13.752 3.81902C13.6082 3.53677 13.3787 3.3073 13.0965 3.16349C12.9073 3.06709 12.7107 3.03144 12.513 3.01529C12.3257 2.99998 12.0983 2.99999 11.8347 3L11.8155 3H4.29207ZM2.69207 11.1489H2.04227C2.17299 11.6036 2.59198 11.9362 3.08865 11.9362H13.0177C13.5144 11.9362 13.9334 11.6036 14.0641 11.1489H13.4155H2.69207ZM3.46508 4.0545C3.4898 4.0419 3.54016 4.02306 3.67599 4.01196C3.81766 4.00039 4.00379 4 4.29207 4H11.8155C12.1038 4 12.2899 4.00039 12.4316 4.01196C12.5674 4.02306 12.6177 4.0419 12.6425 4.0545C12.7366 4.10243 12.813 4.17892 12.861 4.27301C12.8736 4.29773 12.8924 4.34809 12.9035 4.48392C12.9151 4.62559 12.9155 4.81172 12.9155 5.1V10.1489H3.19207V5.1C3.19207 4.81172 3.19246 4.62559 3.20403 4.48392C3.21513 4.34809 3.23397 4.29773 3.24657 4.27301C3.2945 4.17892 3.37099 4.10243 3.46508 4.0545Z"
                      fill="#22135E"
                    />
                  </svg>
                </span>
              ...
              <label
                htmlFor="inputField"
                className={`${style.form_field__label} ${style.has__icon}`}
              >
                Simple field
              </label>
            </div>
          ...
          <div className={`${style.form_field}`}>
            ...
            <div className={`${style.form_field__info}`}>
              {/* {errorMessage && ( */}
              <label className={`${styleLabel.label} ${styleLabel.error}`}>
                Error Error message{" "}
              </label>
              {/* {errorMessage} */}
              {/* )} */}
